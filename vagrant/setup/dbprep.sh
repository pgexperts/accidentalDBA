...
cp /setup/postgres/postgresql.conf /etc/postgresql/9.2/main/postgresql.conf
cp /setup/postgres/pg_hba.conf  /etc/postgresql/9.2/main/pg_hba.conf
...
mkdir /var/lib/postgresql/9.2/replica
mkdir /var/lib/postgresql/backup
chown postgres /var/lib/postgresql/*
chmod 700 /var/lib/postgresql/9.2/replica

#link pg_ctl
ln -s /usr/lib/postgresql/9.2/bin/pg_ctl /usr/bin/pg_ctl
